...
import { editLkfDosis, editLkfPekerja, editLkfSumber, lkfDosisStore } from '@/redux-store/lkf/dataLkf'
import { setTab } from '@/redux-store/lkf'

const FormTldLkf = ({ data, open, handleClose, edit }) => {
  ...
  const onSubmit = dataform => {
    if (dataform) {
      if (edit) {
        dispatch(editLkfDosis({ id: data.id, dataform }))
      } else {
        dispatch(lkfDosisStore({ lkf_id: data.lkf_id, ...dataform }))
      }
