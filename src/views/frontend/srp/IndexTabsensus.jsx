...
const IndexTabsensus = ({ data = [], currentPage, perPage, total, totalPages, searchTerm, tahapRegId }) => {
  ...
  const updateSearchParams = useCallback(
    newParams => {
      ...
      if (normalizedTahapRegId) {
        params.set('tahap_reg_id', normalizedTahapRegId)
      }
    ...
    [normalizedTahapRegId, pathname, router, searchParams, startTransition]
  )
