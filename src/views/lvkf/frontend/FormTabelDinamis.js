...
const FormTabelDinamis = ({ data, dataedit, open, handleClose, edit }) => {
  ...
  const onSubmit = datas => {
    if (datas) {
      ...
      if (edit) {
        dispatch(lkfFormTabeledit({ id: dataedit.baris_ke, dataform }))
      } else {
        dispatch(lkfFormTabel(dataform))
      }
...
export default FormTabelDinamis
