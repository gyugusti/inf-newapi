...
import { editFihiDosis, editFihiPekerja, editFihiSumber, fihiDosisStore } from '@/redux-store/fihi/dataFihi'
import { setTab } from '@/redux-store/fihi'

const FormTldFihi = ({ data, open, handleClose, edit }) => {
  ...
  const onSubmit = dataform => {
    if (dataform) {
      if (edit) {
        dispatch(editFihiDosis({ id: data.id, dataform }))
      } else {
