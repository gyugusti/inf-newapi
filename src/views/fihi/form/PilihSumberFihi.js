...
import {
  ...
  createFihiSumber,
  setFasilitas
} from '@/redux-store/fihi/dataFihi'
import { useSettings } from '@/@core/hooks/useSettings'

const PilihSumberFihi = ({ data, open, handleClose }) => {
  ...
  const { sumberFihi, isLoadingSrp, numOfPagesSrp, totalSrp, current_pageSrp, per_page, searchSrp } = useSelector(
  ...
  const onSubmit = datacheck => {
    if (datacheck) {
      ...
      if (edit) {
        ...
        dispatch(createFihiSumber(dataform))
      }
...
export default PilihSumberFihi
