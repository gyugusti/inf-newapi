...
import { getFihiPekerja, setFasilitas, fihiDosisStore, fihiKesStore, editFihiKes } from '@/redux-store/fihi/dataFihi'
...
const FormStorekesFihi = ({ data, open, handleClose, edit, dataEdit }) => {
  const tahun = format(new Date(data.tgl_fihi), 'yyyy')
  ...
  const onSubmit = dataform => {
    if (dataform) {
      if (edit) {
        dispatch(editFihiKes({ id: dataEdit.id, dataform }))
      } else {
        dispatch(fihiKesStore({ fihi_id: data.fihi_id, ...dataform }))
      }
          ...
          <Controller
            ...
            render={({ field: { value, onChange } }) => (
              <CustomTextField
                ...
                helperText={errors.pemeriksaan_n ? 'This field is required' : ''}
              />
            )}
          />
          ...
          <Controller
            ...
            render={({ field: { value, onChange } }) => (
              <CustomTextField
                ...
                helperText={errors.pemeriksaan_n1 ? 'This field is required' : ''}
              />
            )}
          />
          ...
          <Controller
            ...
            render={({ field: { value, onChange } }) => (
              <CustomTextField
                ...
                helperText={errors.pemeriksaan_n2 ? 'This field is required' : ''}
              />
            )}
          />
          ...
          <Controller
            ...
            render={({ field: { value, onChange } }) => (
              <CustomTextField
                ...
                helperText={errors.pemeriksaan_n3 ? 'This field is required' : ''}
              />
            )}
          />
          ...
          <Controller
            ...
            render={({ field: { value, onChange } }) => (
              <CustomTextField
                ...
                helperText={errors.pemeriksaan_n4 ? 'This field is required' : ''}
              />
            )}
          />
...
export default FormStorekesFihi
