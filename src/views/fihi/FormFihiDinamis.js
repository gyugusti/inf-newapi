...
import { lkfFormTabel, lkfFormTabeledit } from '@/redux-store/lkf'
import { fihiFormTabel, fihiFormTabeledit } from '@/redux-store/fihi'

const FormFihiDinamis = ({ data, dataedit, open, handleClose, edit }) => {
  ...
  const onSubmit = datas => {
    if (datas) {
      ...
      if (edit) {
        dispatch(fihiFormTabeledit({ id: dataedit.baris_ke, dataform }))
      } else {
        dispatch(fihiFormTabel(dataform))
      }
...
export default FormFihiDinamis
