...
import FormFihiDinamis from './FormFihiDinamis'
import KonfirmasiDialog from '@/components/widget/KonfirmasiDialog'
import { fihiFormTabeldelete } from '@/redux-store/fihi'

const FihiTableDinamis = ({ data, id, action }) => {
  ...
  return (
    <>
      ...
      {open && (
        <FormFihiDinamis data={dataForm} dataedit={dataEdit} open={open} handleClose={handleModalClose} edit={edit} />
      )}
      ...
      <KonfirmasiDialog
        ...
        Id={dataId}
        onConfirm={dataId => {
          dispatch(fihiFormTabeldelete({ id: dataId, fihi_id: id }))
...
export default FihiTableDinamis
