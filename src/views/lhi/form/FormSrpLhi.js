...
import { editLhiSumber } from '@/redux-store/lhi/dataLhi'

const FormSrpLhi = ({ data, edit, handleClose }) => {
  ...
  const onSubmit = dataform => {
    if (dataform) {
      dispatch(editLhiSumber({ id: data.id, dataform }))
