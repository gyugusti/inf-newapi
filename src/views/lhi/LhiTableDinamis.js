...
import FormLhiDinamis from './FormLhiDinamis'
import KonfirmasiDialog from '@/components/widget/KonfirmasiDialog'
import { lhiFormTabeldelete } from '@/redux-store/lhi'

const LhiTableDinamis = ({ data, id, action }) => {
  ...
  return (
    <>
      ...
      {open && (
        <FormLhiDinamis data={dataForm} dataedit={dataEdit} open={open} handleClose={handleModalClose} edit={edit} />
      )}
      ...
      <KonfirmasiDialog
        ...
        Id={dataId}
        onConfirm={dataId => {
          dispatch(lhiFormTabeldelete({ id: dataId, lhi_id: id }))
...
export default LhiTableDinamis
