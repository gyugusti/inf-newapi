...
const Login = ({ mode }) => {
  ...
  //   setErrorState(null) // Reset error sebelum mencoba login
  ...
  //     } else {
  //       setErrorState({ message: result.message || 'Login failed. Please check your credentials.' })
  //     }
  //   } catch (error) {
  //     console.error('Error:', error)
  //     setErrorState({ message: 'Something went wrong. Please try again later.' })
  //   }
  // }
  ...
  const onSubmit = async data => {
    ...
    if (res && res.ok && res.error === null) {
      ...
      if (res?.error) {
        ...
        // Jika error adalah "CredentialsSignin", ubah menjadi pesan yang lebih jelas
